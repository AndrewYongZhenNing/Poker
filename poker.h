...
public:
  ...
  // void deal_flop(); // deals first 3 community cards
  // void deal_turn(); // deals 4th community card
  // void deal_river(); // deals 5th community card N.B essentially deal_turn and deal_river have some methods, but I made different functions as to avoid any unforseen subtle errors, can change later
